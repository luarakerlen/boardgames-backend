...
class Boardgame(Base):
    ...
    def __init__(self, name: str, min_players: int, max_players: int, image_url: Union[str, None], description: Union[str, None], ludopedia_url: Union[str, None]):
        ...
        Atributos:
            ...
            description (str): Descrição do jogo de tabuleiro.
